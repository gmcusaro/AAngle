...
@Suite("ArcSeconds tests")
struct ArcSecondsTests {
    ...
    @Test func testArcSecondsNaN() {
        ...
        #expect((nanArcSeconds + value).rawValue.isNaN)
        #expect((value + nanArcSeconds).rawValue.isNaN)
        #expect((nanArcSeconds - value).rawValue.isNaN)
        #expect((value - nanArcSeconds).rawValue.isNaN)
        #expect((nanArcSeconds * value).rawValue.isNaN)
        #expect((value * nanArcSeconds).rawValue.isNaN)
        ...
        #expect(infArcSeconds.normalized().rawValue.isInfinite)
        #expect((infArcSeconds / value).rawValue.isNaN)
        #expect((-infArcSeconds).rawValue.isNaN)
        #expect((infArcSeconds + value).rawValue.isNaN)

        #expect(infArcSeconds.description == "+Inf")
        #expect(negInfArcSeconds.description == "-Inf")
