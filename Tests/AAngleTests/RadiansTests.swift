...
struct RadiansTests {
    ...
    @Test func testRadiansNaN() {
        ...
        #expect((nanRadians + value).rawValue.isNaN)
        #expect((value + nanRadians).rawValue.isNaN)
        #expect((nanRadians - value).rawValue.isNaN)
        #expect((value - nanRadians).rawValue.isNaN)
        #expect((nanRadians * value).rawValue.isNaN)
        #expect((value * nanRadians).rawValue.isNaN)
        ...
        #expect(infRadians.normalized().rawValue.isInfinite)
        #expect((infRadians / value).rawValue.isNaN)
        #expect((-infRadians).rawValue.isNaN)
        #expect((infRadians + value).rawValue.isNaN)
        
        #expect(infRadians.description == "+Inf")
